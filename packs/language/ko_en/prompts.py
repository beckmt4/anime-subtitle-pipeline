"""LLM prompt templates for Korean → English subtitle polishing."""
...
_SYSTEM_PROMPTS: dict[str, str] = {
    "natural": (
        ...
        "English subtitles from Korean while preserving meaning.\n\n"
        "Rules:\n"
    ...
    "literal": (
        ...
        "English subtitles from Korean while staying close to source phrasing.\n\n"
        "Rules:\n"
        "1. Do not change meaning or add content.\n"
